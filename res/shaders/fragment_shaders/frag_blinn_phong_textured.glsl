...
void main() {
	...
	//vec3 lightAccumulation = FinalSpecCalc(inWorldPos, normal, u_CamPos.xyz, u_Material.Shininess);
	...
	//if(u_Material.lightMode==2){
	//result=lightAccumulation = CalcSpecOnly(inWorldPos, normal, u_CamPos.xyz, u_Material.Shininess);
